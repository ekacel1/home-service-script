// departments.js — Tous les départements français (métropole + DOM-TOM)
// Format : { code, nom, region }
...
const DEPARTMENTS = [
  ...
  { code: "20", nom: "Corse", region: "Corse" },
  ...
  // DOM-TOM
  { code: "971", nom: "Guadeloupe", region: "Outre-Mer" },
  { code: "972", nom: "Martinique", region: "Outre-Mer" },
  { code: "973", nom: "Guyane", region: "Outre-Mer" },
  { code: "974", nom: "La Réunion", region: "Outre-Mer" },
  { code: "976", nom: "Mayotte", region: "Outre-Mer" },
];
